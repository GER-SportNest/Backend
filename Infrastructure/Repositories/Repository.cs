    ...
    where TEntity : class
{
        ...
        CancellationToken cancellationToken = default)
    {
        if(selector is not null)
            return GetQuery(predicate, selector)
    ...
    {
        return GetQuery<TEntity>(predicate)
            .ExecuteUpdateAsync(setExpression, cancellationToken);
    }
    ...
    public Task<int> Remove(Expression<Func<TEntity, bool>> predicate, CancellationToken cancellationToken = default)
    {
        return GetQuery<TEntity>(predicate)
    ...
    private async Task<Page<TResult>> GetPaged<TResult>(IQueryable<TResult> query, int page, int pageSize, CancellationToken cancellationToken = default) 
    {
